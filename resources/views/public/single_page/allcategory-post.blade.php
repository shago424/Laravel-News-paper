        ...
        <div class="left_content">
          <div class="single_page">
            <ol class="breadcrumb" style="height: 50px;background-color: #1A5276;color: #fff">
              ...
              <li style="padding-top: 7px"><a href="#">Category Name : {{-- {{ $category->name }} --}}</a></li>
            ...
            <div class="related_post">
               <h3>Category Wise Post <i class="fa fa-thumbs-o-up"></i></h3>
              ...
              <ul class="spost_nav wow fadeInDown animated">
                ...
                <li>
                  <div class="media"> <a class="media-left" href="{{ route('singlepost',$cat_wise->slug) }}"> <img src="{{ asset('upload/postimage/'.$cat_wise->image) }}" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="{{ route('singlepost',$cat_wise->slug) }}"> Aliquam {{ $cat_wise->title }}</a> </div>
                  </div>
                </li>
                @endforeach
              </ul>
